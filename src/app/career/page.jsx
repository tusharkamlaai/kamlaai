...
import { FiUser, FiMail, FiPhone, FiFileText, FiMessageSquare, FiSend, FiCheckCircle, FiX } from 'react-icons/fi';
...
const CareersPage = () => {
  ...
  const sendApplication = async (e) => {
    ...
    try {
      ...
      // Send to Hostinger email via EmailJS
      await emailjs.send(
        '169xaLUN2NBLc9xDi', // Replace with your EmailJS service ID
        'template_your_template_id', // Replace with your EmailJS template ID
        {
          ...
          // For file attachments, you'll need to configure EmailJS accordingly
          // or use a different service that supports file attachments
        },
      ...
      setNotification({
        show: true,
        message: 'Application submitted successfully! We will review your information shortly.',
        type: 'success'
      });
      form.current.reset();
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="p-8 sm:p-10">
            ...
            <form ref={form} onSubmit={sendApplication} className="space-y-6">
              {/* Name */}
              <div>
        ...
        <motion.div 
          ...
          transition={{ duration: 0.6 }}
        >
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-8 text-center">Current Open Positions</h3>
          
          <div className="space-y-4">
            {[
              { title: "AI/ML Engineer", type: "Full-time", location: "Remote" },
              { title: "Frontend Developer", type: "Full-time", location: "Hybrid" },
              { title: "DevOps Specialist", type: "Contract", location: "Remote" },
              { title: "UX/UI Designer", type: "Full-time", location: "On-site" }
            ].map((job, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
                ...
                className="p-6 bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 hover:shadow-md transition-shadow duration-300"
              >
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <button className="mt-4 sm:mt-0 px-4 py-2 text-sm font-medium text-[#FF00FF] hover:text-[#FF00FF]/80 transition-colors duration-300">
                    View Details
                  </button>
                </div>
              </motion.div>
