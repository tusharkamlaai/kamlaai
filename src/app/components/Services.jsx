...
const services = [
  ...
  },
  {
    ...
    features: ["Cloud Migration", "Server Management", "Data Storage", "Disaster Recovery"],
    image: img3
  },
  {
    id: 4,
    ...
    features: ["Process Automation", "Data Analysis", "Market Research", "Workflow Optimization"],
    image: img4
  },
  {
    id: 5,
    ...
    features: ["Customer Support", "IT Services", "HR Management", "Accounting"],
    image: img7
  },
  {
    id: 6,
...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-950">
      {/* Header */}
      <motion.div 
        ref={ref}
      ...
      >
        <h2 className="text-sm font-semibold text-[#FF00FF] mb-3 tracking-wider">OUR EXPERTISE</h2>
        <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-4">
          Comprehensive <span className="text-[#FF00FF]">Digital Solutions</span>
        </h1>
        <p className="text-lg text-gray-600 dark:text-gray-400">
          Cutting-edge services designed to propel your business forward in the digital landscape
        </p>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <div className="mt-8 flex justify-center gap-4">
            <CarouselPrevious className="relative left-0 top-0 translate-y-0 bg-pink-300 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-800 dark:text-white hover:bg-green-300 dark:hover:bg-gray-700" />
            <CarouselNext className="relative right-0 top-0 translate-y-0 bg-pink-300 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-800 dark:text-white hover:bg-green-300 dark:hover:bg-gray-700" />
          </div>
        </Carousel>
      </motion.div>
      ...
      >
        <div className="bg-gradient-to-r from-[#FF00FF]/5 to-purple-500/5 dark:from-[#4B0082]/10 dark:to-[#2E1065]/10 p-8 sm:p-12 rounded-2xl border border-gray-200 dark:border-gray-800">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
            Let's discuss how we can create custom solutions tailored to your unique requirements.
          </p>
