            ...
            {navItems.map((item) => (
              <div key={item.name} className="relative">
                {item.submenu ? (
                  ...
                  <Link
                    href={item.href}
                    className="px-4 dark:text-white py-2 rounded-lg text-gray-800 hover:text-purple-700 hover:bg-pink-200 transition-colors font-medium"
                  >
                    {item.name}
                  </Link>
                )}
            ...
            <div className="px-4 pt-2 pb-6 space-y-2">
              {navItems.map((item) => (
                ...
                >
                  {item.submenu ? (
                    ...
                    <Link
                      href={item.href}
                      className="block py-3 px-2 rounded-lg text-gray-800 hover:text-white hover:bg-purple-600 transition-colors font-medium"
                      onClick={() => setIsOpen(false)}
                    >
                      {item.name}
                    </Link>
              ...
              <div className="flex space-x-4 pt-4 px-2">
                <motion.button
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                  className="p-2 rounded-full text-gray-700 hover:text-white hover:bg-purple-600 transition-colors shadow-sm"
                >
